let add_room_form = document.getElementById('add_room_form');
    ...
    function add_room()
    {
        ...
        xhr.onload = function(){
            ...
            if(this.responseText == 1){
                ...
                alert('error','New room failed to add! Try again later');
            }
        }
    ...
    function submit_edit_room()
    {
        ...
        xhr.onload = function(){
            ...
            if(this.responseText == 1){
                ...
                alert('error','Romm data failed to update! Try again later');
            }
        }
    ...
    function add_image()
    {
            ...
            if(this.responseText == 'inv_img')
        {
            ...
            alert('success','New Room Image added!','image-alert');
    ...
    function rem_image(img_id,room_id)
    {
        ...
        xhr.onload = function(){
            ...
            if(this.responseText == 1)
        {
            alert('success','Room Image Removed!','image-alert');
